...
Если прослушиватель обновляет состояние, не забудьте [сохранить состояние](bot-builder-concept-state.md) перед завершением работы этого прослушивателя.
