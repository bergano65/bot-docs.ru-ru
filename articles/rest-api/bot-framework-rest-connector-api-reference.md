...
| **значение** | object | Дополнительный параметр для этого действия. Поведение этого свойства будет меняться в зависимости от **типа** действия. Дополнительные сведения см. в статье [Добавление форматированных карточек как вложения к сообщениям](bot-framework-rest-connector-add-rich-cards.md). |
...
| **body** | object | Текст из невыполненного запроса. |
...
| Свойство | type | ОПИСАНИЕ |
|----|----|----|
| **entities** | object | Объект, где значение каждого свойства является объектом [Entity](#entity-object). |
