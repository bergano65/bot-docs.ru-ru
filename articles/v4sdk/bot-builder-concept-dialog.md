...
Когда начинается новый диалог, он становится активным диалогом, перемещаясь на вершину стека. Он остается активным, пока не завершится, не будет удален с помощью метода [replace dialog](#repeating-a-dialog), или в стек не будет помещен новый диалог (из обработчика шагов или самим активным диалогом), который и станет новым активным диалогом. Когда новый активный диалог завершится, он будет извлечен из стека, и активным снова станет диалог, расположенный на предыдущем уровне стека. Этот механизм поддерживает ветвление и циклы, о которых рассказывается ниже.
