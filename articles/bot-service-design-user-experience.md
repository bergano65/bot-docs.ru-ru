---
title: Проектирование взаимодействия с пользователем — Служба Azure Bot
...
| Карточка рекомендуемых действий | ![Изображение карточки рекомендуемых действий](./media/suggested-actions.png) | Представляет вашему пользователю набор CardActions, представляющий собой выбор пользователя. Эта карточка исчезает после выбора любого из рекомендуемых действий. |
