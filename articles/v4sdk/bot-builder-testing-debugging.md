...
Убедившись, что ваш бот работает надлежащим образом, выполните следующий шаг — подключите его к каналу. Чтобы сделать это, разверните бот на промежуточный сервер и создайте собственный [клиент Direct Line](bot-builder-howto-direct-line.md), к которому будет подключен бот.
