...
На портале Azure щелкните **Тестировать в веб-чате**, чтобы протестировать бот. Попробуйте ввести сообщения, такие как "Create a note", "read my notes" и "delete notes", чтобы вызвать добавленные намерения.
