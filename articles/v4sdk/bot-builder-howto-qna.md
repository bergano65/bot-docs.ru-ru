...
Затем мы инициализируем новый экземпляр класса `BotServices` в файле **BotServices.cs**, который извлекает указанные выше сведения из файла .bot. Внешняя служба настраивается с помощью класса BotConfiguration.
