...
Чтобы создать такую базу знаний, воспользуйтесь статьей [Use follow-up prompts to create multiple turns of a conversation](https://aka.ms/qnamaker-multiturn-conversation) (Использование дальнейших подсказок для создания диалога с несколькими шагами) из документации по QnA Maker. Чтобы узнать, как включить в бот поддержку многоэтапных подсказок, ознакомьтесь с примером многоэтапной работы с QnA Maker [[**C#** ](https://aka.ms/cs-qna-multiturn) | [**JS**](https://aka.ms/js-qna-multiturn)].
