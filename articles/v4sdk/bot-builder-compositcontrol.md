...
Первый элемент, добавленный с помощью этого метода, настраивается как начальный диалог. Но это можно изменить, явно задав свойство _initial dialog_ в конструкторе компонентного диалога.
