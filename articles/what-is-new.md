...
Кроме того, Botkit предоставляет шесть адаптеров платформы, позволяя приложениям ботов JavaScript непосредственно взаимодействовать со следующими платформами обмена сообщениями: [Slack][102], [Webex Teams][103], [Google Hangouts][104], [Facebook Messenger][105], [Twilio][106] и [веб-чат][107].
...
- [Скачать последнее решение][61] | [Docs][62]
...
[Документация][31] | [Add language understanding to your bot][32] 
...
[Документация][34]  | [add qnamaker to your bot][35] 
