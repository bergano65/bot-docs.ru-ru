...
description: Как создать пользовательское хранилище с помощью пакета SDK Bot Builder версии 4.0
...
Платформа Bot Builder включает реализацию по умолчанию, которая хорошо подойдет для большинства приложений. Вам достаточно будет объединить все компоненты в нескольких строках кода инициализации. Многие из этих примеров демонстрируют именно такой вариант.
