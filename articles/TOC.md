...
## [Перевод вводимых пользователем данных](v4sdk/bot-builder-howto-translation.md)
## [Интеграция нескольких служб LUIS и QnA Maker с помощью средства подготовки к отправке](v4sdk/bot-builder-tutorial-dispatch.md)
## [Создание ботов с помощью Azure CLI](bot-builder-tools-az-cli.md)
## [Создание ботов с помощью шаблонов Bot Builder](bot-builder-create-templates.md)
# Примеры
...
# Основные понятия
## [Принцип работы приложения-бота Echo](v4sdk/bot-builder-anatomy.md)
## [Основные сведения о ботах](v4sdk/bot-builder-basics.md)
## [Каналы и служба Bot Connector](v4sdk/bot-concepts.md) 
## [Процесс общения](v4sdk/bot-builder-conversations.md)
...
### [Извлечение намерений и сущностей с помощью LUISGen](v4sdk/bot-builder-howto-v4-luisgen.md)
...
### [Создание ПО промежуточного слоя, которое выполняет ведение журнала в Cosmos DB](v4sdk/bot-builder-howto-cosmos-middleware.md)
### [Создание встроенного набора диалогов](v4sdk/bot-builder-compositcontrol.md)
### [Запуск ботов, созданных с помощью пакета SDK версии 3 для .NET, с пакетом SDK версии 4.0](v4sdk/bot-builder-howto-classic.md)
### [Создание бота и клиента Direct Line](v4sdk/bot-builder-howto-direct-line.md)
