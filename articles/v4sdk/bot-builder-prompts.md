...
- Код в этой статье основан на примере dialog-prompt. Вам потребуется копия этого примера на языке [C#](https://aka.ms/dialog-prompt-cs) или [JS](https://aka.ms/dialog-prompt-js).
