...
#### <a name="use-mock-elements-to-test-individual-sections"></a>Использование макетов элементов для тестирования отдельных разделов
...
#### <a name="use-mock-elements-to-test-larger-features"></a>Использование макетов элементов для тестирования более значимых функций
