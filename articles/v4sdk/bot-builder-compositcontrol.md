...
- Опыт работы с [ботами][concept-basics], the [dialogs library][concept-dialogs] и [управлением сообщениями][simple-flow].
- Копия примера диалога с несколькими шагами для [**C#** ][cs-sample] or [**JavaScript**][js-sample].
