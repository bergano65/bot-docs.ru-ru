...
См. подробнее о [добавлении Application Insights в приложение ASP.NET Core](https://docs.microsoft.com/azure/azure-monitor/app/asp-net-core-no-visualstudio). 
