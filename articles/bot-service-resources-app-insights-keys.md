...
1. На сайте [portal.azure.com](http://portal.azure.com) в разделе "Монитор" создайте ресурс **Application Insights** (или используйте имеющийся).
