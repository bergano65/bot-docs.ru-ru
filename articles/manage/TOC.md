...
### [Общие сведения о расширении Службы приложений](../bot-service-channel-directline-extension.md)
### [Использование бота .NET с расширением](../bot-service-channel-directline-extension-net-bot.md)
### [Использование клиента .NET с расширением](../bot-service-channel-directline-extension-net-client.md)
