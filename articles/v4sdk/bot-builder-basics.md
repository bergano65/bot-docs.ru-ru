...
При общении люди обычно говорят по очереди. Как правило, бот реагирует на вводимые пользователем данные. В пакете SDK Bot Builder _ход_ состоит из входного действия пользователя и всех действий, которые бот возвращает пользователю путем мгновенного ответа. Ход можно рассматривать как обработку, связанную с поступлением того или иного действия.
