---
title: Проверка подлинности действий с помощью .NET Core | Документация Майкрософт
description: Сведения о проверке подлинности действий ботов с помощью .NET Core.
author: v-ducvo
ms.author: v-ducvo
manager: kamrani
ms.topic: article
