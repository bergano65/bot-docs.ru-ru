...
ms.locfileid: "39305759"
---
# <a name="write-your-own-middleware"></a>Создание собственного ПО промежуточного слоя
...
Как показано в следующем примере, основываясь на базовом примере HelloBot, к нашим службам добавляются два разных фрагмента ПО промежуточного слоя с новым экземпляром каждого из классов.
