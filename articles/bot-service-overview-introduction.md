...
- Выполните [модульное тестирование](https://docs.microsoft.com/azure/bot-service/unit-test-bots?view=azure-bot-service-4.0) бота с помощью пакета SDK для Bot Framework с обновлением, вышедшем в июле.
