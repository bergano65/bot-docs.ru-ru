...
Метод `Conversation.SendAsync` является основной для реализации диалогов с помощью пакета SDK Bot Framework для .NET. Он следует <a href="https://en.wikipedia.org/wiki/Dependency_inversion_principle" target="_blank">принципу инверсии зависимостей</a> и выполняет следующие действия:
